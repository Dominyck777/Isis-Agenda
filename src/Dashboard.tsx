...
const ISearch = () => <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" /></svg>;
...
export default function Dashboard({ onLogout }: { onLogout: () => void }) {
  ...
  }, [agendamentos, filterProf, filterServ]);
           ...
           <div className="modal-card" onClick={e => e.stopPropagation()} style={{ maxWidth: '400px', width: '90%', padding: '32px 24px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                 <div>
                   ...
                   <select value={tempFilterProf} onChange={e => setTempFilterProf(e.target.value)} style={{ width: '100%', padding: '12px', borderRadius: '8px', background: 'var(--input-bg)', color: '#fff', border: '1px solid var(--border-color)', outline: 'none' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                 {(() => {
                    const dailyAgs = agendamentos.filter(ag => {
                        ...
                        return agDate === currentDate.toDateString();
